...
public final class VeinMinerPlayerManager {
    ...
    /**
     * Get the {@link VeinMinerPlayer} associated with the given {@link PlatformPlayer}.
     *
     ...
     */
    @Nullable
    public VeinMinerPlayer get(@NotNull PlatformPlayer player) {
     ...
     */
    @NotNull
    public VeinMinerPlayer getOrRegister(@NotNull PlatformPlayer player, Supplier<ClientConfig> defaultConfigSupplier) {
    ...
    /**
     * Remove the {@link VeinMinerPlayer} of the given {@link PlatformPlayer}.
     *
     ...
     */
    @Nullable
    public VeinMinerPlayer remove(@NotNull PlatformPlayer player) {
